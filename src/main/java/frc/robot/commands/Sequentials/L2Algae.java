...
public class L2Algae extends SequentialCommandGroup {
  ...
  public L2Algae(Elevator s_elevator, Manipulator s_manipulator, Wrist s_wrist) {
    ...
    addCommands(new InstantCommand( () -> s_elevator.setElevatorPos(Constants.Elevator.highAlgaePosition)));
    addCommands(new RunCommand(() -> s_manipulator.holdBall(), s_manipulator));
  }
}
